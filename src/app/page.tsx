...
const perks = [
  {
    ...
    description:
      'Get your assets delivered to your email and download them right away.',
  },
  {
...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper>
        <div className="py-20 flex flex-col max-w-3xl items-center text-center mx-auto">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            ...
            team to ensure our highlight quality standard.
          </p>
